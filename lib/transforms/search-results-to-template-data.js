...
module.exports = (queryParams, results, mphcParent = null, config) => {
  // console.log(queryParams.type, 'checking typ');
  config = config || {};
  ...
  // transforms uid to more human readable title in filter badge
  ...
  //     break;
  // }
  // console.log(queryParams.type, 'echckjing data');
...
function createResult(item) {
  // console.log(item.links, 'checking links');
  return {
    type: item.type,
