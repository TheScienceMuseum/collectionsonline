...
module.exports = (queryParams, results, config) => {
  ...
  const metaDescription = buildMetaDescription(descriptionBox, titlePage, hasQuery, results.meta);
...
function buildMetaDescription (descriptionBox, titlePage, hasQuery, meta) {
  ...
  // Build from title and result count
  ...
  // Filter pages without results or fixture text — build from title
