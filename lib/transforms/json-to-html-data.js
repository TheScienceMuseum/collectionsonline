...
function getDetails (resource, links) {
  ...
  return [website, category, collection, accession, materials, measurements, identifier, subject, access, arrangement, objectType, taxonomy].concat(legal, notes).filter(el => el);
}
