...
module.exports = (resource) => {
  ...
  // console.log(childRecords, 'checking here');
...
function formatLicense(license) {
  ...
  let ccurl;
  let image;
  if (license && license.usage_terms) {
  ...
  if (license && license.copyright === 'unknown') {
    license.copyright = 'Copyright holder unknown';
  }
  const copyright = license ? license.copyright : '';
  return { details: copyright, usage_terms: formatted, cc, ccurl, image };
}
...
function getChildRecords(
  ...
  // console.log(data.type, 'checking type3');
  ...
  return childRecords.map((record) => {
    ...
    // console.log(record.data.attributes, 'checking attributes');
    // console.log(links, 'checking links');
    ...
    // console.log(record.data, 'checking type3');
    // console.log(links, 'checking type3');
