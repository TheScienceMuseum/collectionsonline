...
function getMasthead (data) {
  ...
  if (data.attributes && data.attributes['@admin'].uid === 'c83918') {
    masthead.image = 'https://collection.sciencemuseumgroup.org.uk/assets/img/explore/banner/1600/IMG_7231.jpg';
    masthead.title = 'Building One';
    masthead.shade = 'dark';
  }
