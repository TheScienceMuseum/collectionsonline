...
module.exports = function (queryParams, filterType) {
  ...
  if (archive) {
    archive.forEach((e) => {
      filters.push({
        terms: { 'fonds.summary.title.keyword': [e, dashToSpace(e)] }
      });
    });
  }
  ...
  if (subgroup) {
    subgroup.forEach((e) => {
      filters.push({
        terms: {
          'sub_group_lower.keyword': [dashToSpace(e.toLowerCase())]
        }
      });
    });
  }
  ...
  if (locations) {
    locations.forEach((e) => {
      filters.push({
        bool: {
          should: [
            { terms: { 'location.name.value.lower': [e.toLowerCase(), dashToSpace(e.toLowerCase())] } },
            { terms: { 'facility.name.value.lower': [e.toLowerCase(), dashToSpace(e.toLowerCase())] } }
          ]
        }
      });
    });
