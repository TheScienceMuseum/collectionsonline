...
module.exports = function (queryParams, filterType) {
  ...
  if (categories) {
    categories.forEach(e => {
      filters.push({ terms: { 'category.name.keyword': [e, e.toLowerCase(), dashToSpace(e)] } });
    });
  }
  ...
  if (collection) {
    collection.forEach(e => {
      filters.push({ terms: { 'cumulation.collector.summary.title.keyword': [e, e.toLowerCase(), dashToSpace(e)] } });
    });
  }
  ...
  if (makers) {
    makers.forEach(e => {
      filters.push({ terms: { 'creation.maker.summary.title.lower': [e, e.toLowerCase(), dashToSpace(e.toLowerCase())] } });
    });
  }
  ...
  if (objectType) {
    objectType.forEach(e => {
      filters.push({ terms: { 'name.value.keyword': [e.toLowerCase(), dashToSpace(e.toLowerCase())] } });
    });
  }
  ...
  if (places) {
    places.forEach(e => {
      filters.push({ terms: { 'creation.place.summary.title.lower': [e.toLowerCase(), dashToSpace(e.toLowerCase())] } });
    });
  }
  ...
  if (user) {
    user.forEach(e => {
      filters.push({ terms: { 'agent.summary.title.lower': [e.toLowerCase(), dashToSpace(e.toLowerCase())] } });
    });
  }
  ...
  if (occupation) {
    occupation.forEach(e => {
      filters.push({ terms: { 'occupation.value.keyword': [e, dashToSpace(e)] } });
    });
  }
  ...
  if (birthPlace) {
    birthPlace.forEach(e => {
      filters.push({ terms: { 'birth.location.name.value.lower': [e.toLowerCase(), dashToSpace(e.toLowerCase())] } });
    });
  }
  ...
  if (organisations) {
    organisations.forEach(e => {
      filters.push({ terms: { '@datatype.actual': [e, e.toLowerCase(), dashToSpace(e.toLowerCase())] } });
    });
  }
  ...
  if (material) {
    material.forEach(e => {
      filters.push({ terms: { 'material.value.keyword': [e, dashToSpace(e)] } });
    });
  }
  ...
  if (locations) {
    locations.forEach(e => {
      filters.push({ terms: { 'facility.name.value.lower': [e.toLowerCase(), dashToSpace(e.toLowerCase())] } });
    });
  }
