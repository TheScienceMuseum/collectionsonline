...
module.exports = function (queryParams, filterType) {
  ...
  if (makers) {
    makers.forEach(e => {
      filters.push({ terms: { 'lifecycle.creation.maker.summary_title': [e, dashToSpace(e)] } });
    });
  }
  ...
  if (objectType) {
    objectType.forEach(e => {
      filters.push({ terms: { 'name.value_lower': [e, dashToSpace(e)] } });
    });
  }
  ...
  if (places) {
    places.forEach(e => {
      filters.push({ terms: { 'lifecycle.creation.places.summary_title': [e, dashToSpace(e)] } });
    });
  }
  ...
  if (user) {
    user.forEach(e => {
      filters.push({ terms: { 'agents.summary_title': [e, dashToSpace(e)] } });
    });
  }
  ...
  if (birthPlace) {
    birthPlace.forEach(e => {
      filters.push({ terms: { 'lifecycle.birth.location.name.value': [e, dashToSpace(e)] } });
    });
  }
  ...
  if (locations) {
    locations.forEach(e => {
      filters.push({ terms: { 'locations.name.value': [e, dashToSpace(e)] } });
    });
  }
