...
module.exports = (typeFormat, queryParams) => {
  ...
  result.filter.objects.organisations = formatValue(typeFormat, organisations);
  ...
  result.filter.objects.user = formatValue(typeFormat, user);
  ...
  result.filter.people.organisations = formatValue(typeFormat, organisations);
