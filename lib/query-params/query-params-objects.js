...
module.exports = function (typeFormat, queryParams) {
  // console.log(queryParams, typeFormat, 'checking params');
  ...
  // console.log(material, 'ceching params');

  const mphc = queryParams.query['filter[mphc]'] || null;

  queryParamsObjects.mphc = formatValue(typeFormat, mphc);
  // console.log(mphc, 'ceching params');
  // console.log(queryParamsObjects, 'ceching params');
