...
var nameFromFilter = function (selectedFilters) {
  ...
  var collection = selectedFilters.collection && Object.keys(selectedFilters.collection)[0];
  ...
  var exclude = ['categories', 'collection', 'museum', 'gallery', 'type', 'page[size]', 'page[type]', 'page[number]'];
