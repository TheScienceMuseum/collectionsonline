  ...
  [
    ...
    (cb) => {
      Async.each(
        [
          ...
          // { id: 'c81734', type: 'group', filename: 'example-get-response-group' }
        ],
        (data, cb) => {
    ...
    async () => {
      const response = await search(
        elastic,
        createQueryParams('html', { query: { q: 'test' }, params: {} })
      );
      Fs.writeFile(
        dirData + '/../../helpers/aggregations-all.json',
