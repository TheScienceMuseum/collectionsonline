...
const children = sortRelated(require('../fixtures/elastic-responses/database.json').children['smga-archive-110000003'].response.hits.hits);
...
test('Data fields should have correct values', function (t) {
  ...
  t.equal(HTMLData.related.documents.length, 5, 'Data should contain five related documents');
