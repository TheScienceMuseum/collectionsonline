...
test(file + 'Person template data is correctly built', (t) => {
  ...
  t.equal(personResult.link, '/people/smgc-people-36993/charles-babbage', 'person link is correct');
...
test(file + 'Object template data is correctly built', (t) => {
  ...
  t.equal(objectResult.link, '/objects/smgc-objects-8245103/packet-of-technetium-mdp-for-bone-scintigraphy-amerscan-agent-phial-packet-materia-medica', 'object link is correct');
