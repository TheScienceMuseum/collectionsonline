module.exports = {
  'Selecting multiple filters on search page': function (browser) {
    browser
      ...
      .pause(2000)
      .assert.urlEquals('http://localhost:8000/search/object_type/bottles?page[size]=50')
      .waitForElementVisible('.filter__box[value="tablets"]', 5000)
      .click('.filter__box[value="tablets"]')
      .pause(2000)
      .assert.urlEquals('http://localhost:8000/search/object_type/bottles+tablets?page[size]=50')
