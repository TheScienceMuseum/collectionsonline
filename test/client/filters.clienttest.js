module.exports = {
  'Filtering on search page': function (browser) {
    browser
      ...
      .pause(1000)
      .assert.urlEquals('http://localhost:8000/search/people?q=charles&page%5Bsize%5D=50&filter%5Boccupation%5D=artist&filter%5Boccupation%5D=inventor')
      .click('.filter__box[value=inventor]')
      .click('.filter__box[value=artist]')
      .pause(1000)
      .click('.filter__box[value="England, United Kingdom"]')
      .pause(1000)
      .assert.urlEquals('http://localhost:8000/search/people?q=charles&page%5Bsize%5D=50&filter%5Bbirth%5Bplace%5D%5D=England,%20United%20Kingdom')
      .click('.filter__box[value="England, United Kingdom"]')
      .pause(1000)
      .assert.urlEquals('http://localhost:8000/search/people?q=charles&page%5Bsize%5D=50')
      .click('.filter__box[value="England, United Kingdom"]')
