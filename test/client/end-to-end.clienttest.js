module.exports = {
  'Search from home Page': function (browser) {
    browser
      ...
      .setValue('input[type=search].searchbox__search.tt-input', 'ada')
      ...
      .assert.urlEquals('http://localhost:8000/search?q=ada')
      .pause(1000)
      .clearValue('input[type=search].searchbox__search.tt-input')
      .pause(1000)
      .setValue('input[type=search].searchbox__search.tt-input', 'charles babbage')
      .pause(1000)
      .click('button.searchbox__submit')
      .pause(1000)
